...
<?php $this->load->view('default/menu',array('menu' => 'quienes_somos')); ?>
	...
	<div class="row">
		<div class="form-group col-lg-12">
			...
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de
